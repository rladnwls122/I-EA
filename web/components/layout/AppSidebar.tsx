...
export function AppSidebar() {
  ...
  return (
    <>
      {/* 데스크톱 — 좌측 고정 레일(md 이상) */}
      <aside data-app-nav className="fixed left-0 top-0 bottom-0 z-50 hidden w-[64px] flex-col items-center border-r border-border bg-sidebar py-5 md:flex print:hidden">
        <Link
          href="/"
          aria-label="홈"
